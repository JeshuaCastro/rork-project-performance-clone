...
export default function DashboardScreen() {
  ...
  // Render today's sleep metrics for dashboard sleep tab
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    paddingRight: iosMargins.screen,
  ...
  connectBanner: {
    ...
    paddingHorizontal: iosMargins.cardPadding,
  },
  connectBannerText: {
    flex: 1,
  ...
  tabContainer: {
    flexDirection: 'row',
    backgroundColor: colors.ios.secondaryBackground,
    marginHorizontal: iosMargins.screen,
    marginVertical: 6,
    borderRadius: 10,
    padding: 2,
    ...iosCardShadow,
